...
public class SubmitSM extends Request
{
	...
	protected ShortMessage	shortMessage			= new ShortMessage(Data.SM_MSG_LEN);
	...
	public void setShortMessageData(ByteBuffer buffer)
			throws PDUException, NotEnoughDataInByteBufferException,
			TerminatingZeroNotFoundException
	{
