/**
 * TpMerchantAccountID_Helper.java
 *
...
public class TpMerchantAccountID_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TpMerchantAccountID.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.csapi.org/cs/schema", "TpMerchantAccountID"));
